...
const App = () => {
  ...
  const API_KEY = '1cbe89aaafad9bc4ab14d058c08a3585'
  ...
  // check weather exists and return a function
  ...
  return (
    <div className='min-h-screen'>
      ...
      <div className='flex items-center justify-center p-6 min-h-screen'>
        <div className='bg-transparent bacdrop-filter backdrop-blur-md rounded-xl shadow-2xl p-8 max-w-md
